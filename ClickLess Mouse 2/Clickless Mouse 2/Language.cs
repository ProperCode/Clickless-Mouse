        ...
        void set_instructions(language lang)
        {
            if(lang == language.en)
            {
                ...
                p1.Inlines.Add(new Run(").\n\nBy using Clickless Mouse with a virtual keyboard " +
                    "the user "
                    + "can fully control a computer by moving mouse with a palm, a forearm or a foot."
                ...
                BitmapImage bitmap = new BitmapImage(new Uri(
                    "pack://application:,,,/Clickless Mouse 2.02;component/1en.jpg"));
                ...
                fd.Blocks.Add(p4);
                fd.Blocks.Add(a3);
                wi.RTBinstructions.Document = fd;
            }
            else if(lang == language.pl)
            {
                wi.Title = "Instrukcja obsługi";
                ...
                p1.Inlines.Add(new Run(").\n\nUżywając Clickless Mouse wraz z Free Virtual Keyboard"
                    + " użytkownik może w pełni kontrolować komputer poprzez poruszanie myszką za " +
                    "pomocą dłoni, przedramienia lub stopy."
                ...
                BitmapImage bitmap = new BitmapImage(new Uri(
                    "pack://application:,,,/Clickless Mouse 2.02;component/1pl.jpg"));
                System.Windows.Controls.Image image = new System.Windows.Controls.Image();
                image.Source = bitmap;
                image.Width = 521;
                p2.Inlines.Add(image);
